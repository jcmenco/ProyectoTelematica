...
var conection = mysql.createConnection({
    host     : 'telematica.cphvv1knh4lu.us-east-1.rds.amazonaws.com',
    user     : 'juanc',
    password : 'juancamilo22',
    database : 'telematica'
}); 
...
app.get('/medico-home', (req,res) => {
    ...
    conection.query(selector, (error, result) => {
        ...
        console.log(casosTratamiento,"t")
        console.log(casosNegativos,"n")
        console.log(casosUCI,"u")
...
// Lista de casos registrados
app.post('/lista-m-r', (req,res) => {
    var selector = 'SELECT * FROM Casos;'
    conection.query(selector, (error, result) => {
        if (error) throw error;
        res.render('medico-revision.ejs',{
            data: result,
            alert: ""
        });
    });
